...
class StartButtom extends Component {
  ...
  render() {
    return (
      <li className={NavBar["nav-item"]} href="#Start" id="start">
        <a href="#" className={NavBar["nav-link"]}>
          ...
          <span className={Navbar["link-text"]} onClick={() => this.BackendControl("start")}>Start</span>
        </a>
      </li>
    )
  }
...
class StopButtom extends Component {
  ...
  render() {
    return (
      <li className={NavBar["nav-item"]} href="#Stop" id="stop">
        <a href="#" className={NavBar["nav-link"]} id="StopButtom">
          ...
          <span className={Navbar["link-text"]} onClick={() => this.BackendControl("stop")}>Stop</span>
        </a>
      </li>
    )
  }
  ...
  render() {
    return (
      <li className={NavBar["nav-item"]}>
        <a href="/settings" className={NavBar["nav-link"]}>
...
class PlayerShotcurt extends Component {
  ...
  render() {
    return (
      <li className={NavBar["nav-item"]}>
        <a className={NavBar["nav-link"]} href="players">
          ...
          <span className={Navbar["link-text"]}>Player</span>
        </a>
      </li>
    )
  }
    ...
    return (
      <li className={NavBar["nav-item"]}>
        <a className={NavBar["nav-link"]}>
          ...
          <span className={Navbar["link-text"]}>Backup</span>
        </a>
      </li>
    )
  }
...
class Logout extends Component {
  ...
  render() {
    return (
      <li className={NavBar["nav-item"]} id="Logout">
        <a className={NavBar["nav-link"]} href="logout">
          <svg version="1.1" fill="currentColor" x="0px" y="0px" viewBox="0 0 384.971 384.971">
...
class Navbar extends Component {
  ...
  render() {
    return (
      <nav className={NavBar.navbar} id="navbarID">
          <ul className="navbar-nav" style={{listStyleType: "none"}}>
              <li>
                  <a href={"/"} className={NavBar["nav-link"]}>
                      <span className={Navbar["link-text"]}>Bds Maneger</span>
                  </a>
              </li>
              <li className={NavBar["nav-link"]}></li>
              {/* Start Buttom */}
              <StartButtom />
